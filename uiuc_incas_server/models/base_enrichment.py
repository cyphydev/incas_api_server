...
class BaseEnrichment(object):
    ...
    def __init__(self, provider_name=None, enrichment_name=None, version=None, enrichment_type=None):  # noqa: E501
        """BaseEnrichment - a model defined in Swagger"""  # noqa: E501
    ...
    def provider_name(self):
        """Gets the provider_name of this BaseEnrichment.  # noqa: E501

        The team (e.g., UIUC-DMG) who provides the enrichment.  # noqa: E501

        :return: The provider_name of this BaseEnrichment.  # noqa: E501
        :rtype: str
        """
    ...
    def provider_name(self, provider_name):
        """Sets the provider_name of this BaseEnrichment.

        The team (e.g., UIUC-DMG) who provides the enrichment.  # noqa: E501

        :param provider_name: The provider_name of this BaseEnrichment.  # noqa: E501
        :type: str
        """
    ...
    def enrichment_name(self):
        """Gets the enrichment_name of this BaseEnrichment.  # noqa: E501

        The enrichment (e.g., Concern-Stance) name for the enrichment.  # noqa: E501

        :return: The enrichment_name of this BaseEnrichment.  # noqa: E501
        :rtype: str
        """
    ...
    def enrichment_name(self, enrichment_name):
        """Sets the enrichment_name of this BaseEnrichment.

        The enrichment (e.g., Concern-Stance) name for the enrichment.  # noqa: E501

        :param enrichment_name: The enrichment_name of this BaseEnrichment.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this BaseEnrichment.  # noqa: E501

        The version within the same (provider, name).  # noqa: E501

        :return: The version of this BaseEnrichment.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this BaseEnrichment.

        The version within the same (provider, name).  # noqa: E501

        :param version: The version of this BaseEnrichment.  # noqa: E501
        :type: str
        """
    ...
    def enrichment_type(self):
        """Gets the enrichment_type of this BaseEnrichment.  # noqa: E501

        For discriminator  # noqa: E501

        :return: The enrichment_type of this BaseEnrichment.  # noqa: E501
        :rtype: str
        """
    ...
    def enrichment_type(self, enrichment_type):
        """Sets the enrichment_type of this BaseEnrichment.

        For discriminator  # noqa: E501

        :param enrichment_type: The enrichment_type of this BaseEnrichment.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BaseEnrichment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseEnrichment):
            return False
