...
class ActorMessageGraph(Model):
    ...
    def graph_type(self) -> str:
        """Gets the graph_type of this ActorMessageGraph.

        For discriminator  # noqa: E501

        :return: The graph_type of this ActorMessageGraph.
        :rtype: str
        """
    ...
    def graph_type(self, graph_type: str):
        """Sets the graph_type of this ActorMessageGraph.

        For discriminator  # noqa: E501

        :param graph_type: The graph_type of this ActorMessageGraph.
        :type graph_type: str
        """
