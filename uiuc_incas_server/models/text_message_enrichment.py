...
class TextMessageEnrichment(Model):
    ...
    def __init__(self, message_uuid: str=None, provider_name: str=None, enrichment_name: str=None, version: str=None, confidence: float=None, enrichment_type: str=None, attribute_value: str=None):  # noqa: E501
        ...
        :param enrichment_type: The enrichment_type of this TextMessageEnrichment.  # noqa: E501
    ...
    def enrichment_type(self) -> str:
        """Gets the enrichment_type of this TextMessageEnrichment.

        For discriminator  # noqa: E501

        :return: The enrichment_type of this TextMessageEnrichment.
        :rtype: str
        """
    ...
    def enrichment_type(self, enrichment_type: str):
        """Sets the enrichment_type of this TextMessageEnrichment.

        For discriminator  # noqa: E501

        :param enrichment_type: The enrichment_type of this TextMessageEnrichment.
        :type enrichment_type: str
        """
