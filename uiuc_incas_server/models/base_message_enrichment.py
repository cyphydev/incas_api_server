...
class BaseMessageEnrichment(Model):
    ...
    """
    def __init__(self, message_uuid: str=None, provider_name: str=None, enrichment_name: str=None, version: str=None, confidence: float=None, enrichment_type: str=None):  # noqa: E501
    ...
    def enrichment_type(self) -> str:
        """Gets the enrichment_type of this BaseMessageEnrichment.

        For discriminator  # noqa: E501

        :return: The enrichment_type of this BaseMessageEnrichment.
        :rtype: str
        """
    ...
    def enrichment_type(self, enrichment_type: str):
        ...
        :param enrichment_type: The enrichment_type of this BaseMessageEnrichment.
        :type enrichment_type: str
        """
