...
class BaseMessageEnrichmentMeta(Model):
    ...
    def __init__(self, provider_name: str=None, enrichment_name: str=None, version: str=None, enrichment_type: str=None):  # noqa: E501
        """BaseMessageEnrichmentMeta - a model defined in Swagger
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'BaseMessageEnrichmentMeta':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The BaseMessageEnrichmentMeta of this BaseMessageEnrichmentMeta.  # noqa: E501
        :rtype: BaseMessageEnrichmentMeta
        """
        return util.deserialize_model(dikt, cls)

    @property
    def provider_name(self) -> str:
        """Gets the provider_name of this BaseMessageEnrichmentMeta.

        The team (e.g., UIUC-DMG) who provides the enrichment.  # noqa: E501

        :return: The provider_name of this BaseMessageEnrichmentMeta.
        :rtype: str
        """
    ...
    def provider_name(self, provider_name: str):
        ...
        :param provider_name: The provider_name of this BaseMessageEnrichmentMeta.
        :type provider_name: str
        """
    ...
    def enrichment_name(self) -> str:
        """Gets the enrichment_name of this BaseMessageEnrichmentMeta.

        The enrichment (e.g., Concern-Stance) name for the enrichment.  # noqa: E501

        :return: The enrichment_name of this BaseMessageEnrichmentMeta.
        :rtype: str
        """
    ...
    def enrichment_name(self, enrichment_name: str):
        ...
        :param enrichment_name: The enrichment_name of this BaseMessageEnrichmentMeta.
        :type enrichment_name: str
        """
    ...
    def version(self) -> str:
        """Gets the version of this BaseMessageEnrichmentMeta.

        The version within the same (provider, name).  # noqa: E501

        :return: The version of this BaseMessageEnrichmentMeta.
        :rtype: str
        """
    ...
    def version(self, version: str):
        ...
        :param version: The version of this BaseMessageEnrichmentMeta.
        :type version: str
        """
    ...
    def enrichment_type(self) -> str:
        """Gets the enrichment_type of this BaseMessageEnrichmentMeta.

        For discriminator  # noqa: E501

        :return: The enrichment_type of this BaseMessageEnrichmentMeta.
        :rtype: str
        """
    ...
    def enrichment_type(self, enrichment_type: str):
        ...
        :param enrichment_type: The enrichment_type of this BaseMessageEnrichmentMeta.
        :type enrichment_type: str
        """
