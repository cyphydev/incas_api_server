...
class ActorToActorEdge(Model):
    ...
    """
    def __init__(self, edge_id: str=None, time_stamp: str=None, provider_name: str=None, enrichment_name: str=None, distance_name: str=None, version: str=None, distance: float=None, actor_id1: str=None, actor_id2: str=None, weight: float=None):  # noqa: E501
