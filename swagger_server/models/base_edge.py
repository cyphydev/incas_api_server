...
class BaseEdge(Model):
    ...
    """
    def __init__(self, edge_id: str=None, time_stamp: str=None, provider_name: str=None, enrichment_name: str=None, distance_name: str=None, version: str=None, distance: float=None):  # noqa: E501
