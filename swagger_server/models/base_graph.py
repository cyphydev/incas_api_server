...
class BaseGraph(Model):
    ...
    """
    def __init__(self, graph_id: str=None, provider_name: str=None, graph_name: str=None, distance_name: str=None, version: str=None, time_stamp: str=None, platform: str=None):  # noqa: E501
